...
pub trait Planet {
    // Convert seconds from duration into years, then use orbital period to get years on that planet
    fn years_during(&self, d: &Duration) -> f64 {
        (d.duration as f64) * (1.0 / 31557600.0)
    }
}
...
impl Planet for Mercury {
    fn years_during(&self, d: &Duration) -> f64 {
        (d.duration as f64) * (1.0 / 31557600.0) * (1.0 / 0.2408467)
    }
}
impl Planet for Venus {
    fn years_during(&self, d: &Duration) -> f64 {
        (d.duration as f64) * (1.0 / 31557600.0) * (1.0 / 0.61519726)
    }
}
impl Planet for Earth {
    fn years_during(&self, d: &Duration) -> f64 {
        (d.duration as f64) * (1.0 / 31557600.0) * (1.0 / 1.0)
    }
}
impl Planet for Mars {
    fn years_during(&self, d: &Duration) -> f64 {
        (d.duration as f64) * (1.0 / 31557600.0) * (1.0 / 1.8808158)
    }
}
impl Planet for Jupiter {
    fn years_during(&self, d: &Duration) -> f64 {
        (d.duration as f64) * (1.0 / 31557600.0) * (1.0 / 11.862615)
    }
}
impl Planet for Saturn {
    fn years_during(&self, d: &Duration) -> f64 {
        (d.duration as f64) * (1.0 / 31557600.0) * (1.0 / 29.447498)
    }
}
impl Planet for Uranus {
    fn years_during(&self, d: &Duration) -> f64 {
        (d.duration as f64) * (1.0 / 31557600.0) * (1.0 / 84.016846)
    }
}
impl Planet for Neptune {
    fn years_during(&self, d: &Duration) -> f64 {
        (d.duration as f64) * (1.0 / 31557600.0) * (1.0 / 164.79132)
    }
}
